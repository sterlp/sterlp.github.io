...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.toggleSideBar = function () {
        var shown = this.document.body.classList.contains('sidebar-lg-show');
        var shownSmall = this.document.body.classList.contains('sidebar-show');
...
var SidebarComponent = /** @class */ (function () {
    function SidebarComponent(document, renderer) {
        this.document = document;
        this.renderer = renderer;
    ...
    SidebarComponent.prototype.doMinimize = function () {
...
var ToggleDirective = /** @class */ (function () {
    function ToggleDirective(el, renderer) {
        this.el = el;
        this.renderer = renderer;
    }
    ToggleDirective.prototype.ngOnInit = function () {
        if (this.appToggle == '')
            this.appToggle = 'open';
    };
    ToggleDirective.prototype.onClick = function () {
